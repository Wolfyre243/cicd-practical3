      ...
      <div className="flex items-center justify-between">
        ...
        {user && (
          <span className="text-sm text-slate-600">
            Welcome,{" "}
            <span
              className="font-medium text-slate-9
00"
            >
              {user.username}
            </span>
      ...
      <ul
        className="divide-y divide-slate-200 bg-white rounde
d-md border"
      >
        {tasks.map((t) => (
...
"
                  >
                    ...
                    {t.assignedTo && (
                      <span
                        className="text-xs bg-blue-100 tex
t-blue-700 px-2 py-1 rounded"
                      >
                        Assigned to:{" "}
                        {t.assignedTo.profile?.fullName || t.assignedTo.email}
                      </span>
                    )}
                    <span
                      className={`text-xs px-2 py-1 rounde
d ${t.done ? "bg-green-100 text-green-700" : "bg-yellow-100 text-yellow-700"}`}
                    >
